...
$cat = mysql_query("SELECT * FROM categories ORDER BY id");
...
?>
                                    ...
                                    <select style="display:none" class="form-control" name="rate" id="rate" onkeyup="kalkulatorTambah(this.value,getElementById('quantity').value);" required="required">
</select>
Keterangan :<br/>
<span id="rate1">
</span><br/>
...
<label>Link:</label>
 ...
 <tr>
 <label>Jumlah :</label>
  <td><input class="form-control" id="quantity" name="quantity" type="text" onkeyup="kalkulatorTambah(getElementById('rate').value,this.value);" required="required"></td>
 </tr>
  <tr> 
    <td>Total :</td> 
Rp.<span class="form-control" id="result" name="result"> </span>
            </tr> 
             <script type="text/javascript">
...
<div class="checkbox">
 ...
 <tr>
  <td><input class="btn btn-default large" enabled="enabled" value="Submit" type="submit"></td>
 </tr>
...
<li><b>Setelah order dimasukan, username/link yang diinput jangan diganti pribadi [private] atau diubah, kami tidak akan me-refund. Pastikan Anda memasukkan data yang benar, karena Kami tidak akan lagi membatalkan pesanan.</b></li>
<li><b>Kesalahan member adalah bukan tanggung jawab admin, karena panel ini serba otomatis. Jadi, hati-hati dan perhatikan sebelum order!</b></li>
