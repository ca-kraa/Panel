...
<span class="text-semibold">Password berhasil diganti!</span>
</div></div>';
}
...
$pass = $_POST['password'];
$query = mysql_query("update users set password='$pass' where username='".$_SESSION['username']."'");
                            ...
                            <form action="" method="post" class="form-horizontal">
                                ...
                                <div class="panel panel-default tabs">                            
                                    ...
                                    <div class="panel-body tab-content">
                                        <div class="tab-pane active" id="tab-first">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                            
                                                    <input type="text" class="form-control" value="<?php echo"$pass";?>" readonly/>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">Ganti Password</label>
                                                <div class="col-md-6 col-xs-12">                                            
                                    ...
                                    <div class="panel-footer">                                                                        
                                        <center><button name="submit" class="btn btn-primary pull-right">Save Changes <span class="fa fa-floppy-o fa-right"></span></button></center>
                                    </div>
                                </div>                                
