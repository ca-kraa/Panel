        ...
        <div class="page-container">
            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>  
                    <li class="active">Orderan Sosmed</li>
                </ul>
                <!-- END BREADCRUMB -->

                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Orderan Sosmed</h2>
                </div>
                <!-- END PAGE TITLE -->                
<?php echo"$sukess";?>
<?php echo"$error";?>
...
$idgan = $hasil['id'];
$data1= mysql_query("SELECT * FROM orders WHERE user_id = '$idgan' order by id DESC");
...
$data2= mysql_query("SELECT * FROM services WHERE id = '$servisid'");
